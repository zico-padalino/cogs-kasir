...
@section('heading', 'Edit Biaya Operasional')
@section('subheading', $rate->name)

@section('content')
    <div class="mx-auto max-w-xl">
        <x-step-header number="1" title="Edit Biaya Operasional" description="Perbarui aturan biaya tambahan produksi." />
        ...
        <div class="card">
            <form action="{{ route('overhead-rates.update', $rate) }}" method="POST" class="space-y-4">
                ...
                <label class="flex items-center gap-2">
                    ...
                    <span class="text-sm">Aktif dipakai perhitungan</span>
                </label>
