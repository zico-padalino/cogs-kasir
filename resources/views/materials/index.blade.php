        ...
        <x-table-card :step="2" title="Daftar Bahan Baku" :subtitle="$materials->count() . ' bahan terdaftar'">
            @if ($materials->isNotEmpty())
                    ...
                    @foreach ($materials as $material)
                        ...
                        >
                            ...
                            <div class="material-card__actions">
                                ...
                                <details class="material-card__action">
                                    <summary class="btn-outline btn-sm cursor-pointer list-none text-center">Ubah sisa</summary>
                                    <form
                            ...
                            @php
                                $activeLots = $material->inventoryLots->where('quantity_remaining', '>', 0);
                            @endphp
                            @if ($activeLots->isNotEmpty())
                                <details class="material-lots material-lots-fold mt-3" @if ($activeLots->count() <= 2) open @endif>
                                    <summary>
                                        <span>Batch stok</span>
                                        <span class="material-lots-fold__count">{{ $activeLots->count() }}</span>
                                    </summary>
                                    <div class="material-lots-fold__body">
                            ...
                            @else
                                <p class="mt-3 rounded-lg border border-dashed border-slate-200 bg-slate-50 px-3 py-2 text-xs text-slate-500">
                                    Belum ada stok. Pakai <strong>Ubah sisa</strong> atau <strong>+ Tambah stok</strong>.
                                </p>
                            @endif
                        </div>
                    @endforeach
                ...
                <x-slot:footer>
                    ...
                    <a href="{{ route('products.index') }}" class="btn-primary">Lanjut ke Menu →</a>
                </x-slot:footer>
            @else
