...
<body class="app-body is-admin min-h-screen bg-[#f6f1ea] font-sans text-slate-900 antialiased">
        ...
        <div class="app-frame flex min-h-0 flex-1 flex-col md:min-h-screen">
            ...
            <div class="app-content flex min-h-0 min-w-0 flex-1 flex-col md:pl-64">
                @include('layouts.partials.mobile-topbar', [
                    ...
                    'defaultSubtitle' => auth()->user()->name,
                ])
                ...
                <header class="page-header sticky top-0 z-20 hidden shrink-0 border-b border-slate-200 bg-white/90 backdrop-blur md:block">
                    <div class="page-header-inner">
                        <div class="flex min-w-0 items-center gap-3">
                            ...
                            <div class="min-w-0">
                                <h1 class="page-header-title">@yield('heading', 'Admin')</h1>
                                @hasSection('subheading')
                                    <p class="page-header-sub">@yield('subheading')</p>
                                @endif
                            </div>
                        </div>
                        <p class="page-header-meta">{{ auth()->user()->name }}</p>
                    </div>
                </header>
