...
<body
    ...
    data-dapur-poll-interval="{{ $pollInterval ?? config('pos.notifications.poll_interval_seconds', 60) }}"
    data-dapur-continuous-poll="{{ config('pos.notifications.dapur_poll_enabled', false) ? '1' : '0' }}"
